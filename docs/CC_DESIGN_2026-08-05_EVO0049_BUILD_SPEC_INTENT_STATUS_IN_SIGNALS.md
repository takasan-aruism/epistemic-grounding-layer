# 【BUILD SPEC】`EVO-0049` — **★『分からない』を signals に載せる（★列挙は増やさない）**
...
**★封印試験（★8本・★fixture は `preflight_gate.py:250-253` の実物の形）**
```
