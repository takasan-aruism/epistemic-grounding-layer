...
| **G-69** | 「欠損・失敗の記録なし」が2つの場合をまとめている（起きなかった/記録されなかった）＝**4段目** | Gap | 未着手（★登記のみ・裁定待ち） |
...
| **G-75** | **Taka 残件③「DW枝の到達性確認」が★資料に登記されていなかった**（登記漏れ・CC-α の責）∴ **現況を資料から出せない** | Gap | 未着手（★中身は**測っていない**。「未着手」とも「済」とも書かない） |
