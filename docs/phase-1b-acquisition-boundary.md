...
- **ACQ-10(JREV-0006 で強化)**: 自律 RD は次を **全て** 満たすまで有効化しない——
  (A) acquisition boundary の構造 test 通過、(B) real Gate4/ETB の敵対ラウンド完了、
  (C) **SELF_GROUNDING benchmark の敵対1ラウンド完了**、[JREV-0007 で CONDITIONALLY_SATISFIED: model=Qwen3.6-35B/prompt=self-grounding-1b.0/corpus=47rec/traps=SG-A..I/attacker=1/rounds=1。behavioral 9/9 + validator N-1/N-2 修正。『SELF_GROUNDING validation complete』でなく『1必須ラウンド完了』](D) bootstrap_eligible / factual admission が
  UNRESOLVED / policy 非適格 claim を安定知識・自律化原料へ受理しない(DE-0039/0040)。
  理由: 最初の自律 RD が、EGL が current / historical / reported / property-scoped-verified / unresolved /
  superseded を区別できる速度より速く知識を生産してはならない。
