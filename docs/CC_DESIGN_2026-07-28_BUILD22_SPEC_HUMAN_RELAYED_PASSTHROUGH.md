...
**目的**: **依頼主の言葉を「依頼主が書いた」として台帳に残せるようにする。** **「全案件を台帳経由で管理する」の前提条件である。**
